...
import 'package:RYMSValuer/secondpage.dart' as s;
...
class _stepformState extends State<stepform> {
  ...
  continued(){
    ...
    if(_currentStep==0)
      {
        if(widget.file!=null&&d.desFile.trim()!="")
          {
            _currentStep < 2 ?
            setState(() =>
            _currentStep += 1): null;
    ...
    else if(_currentStep==1)
    {
    ...
    else if(_currentStep==2)
      {
            ...
            d.tankerBody1!=null&&d.vehicle1!=null)
        {
          d.tailGate1=null;d.leftSidegt1=null; d.leftCondn1=null;
          d.rightSidegt1=null;d.RightCondtn1=null
          ;d.loadBody1=null;s.overAll1=null;
          d.chassisCnd1=null;d.Tyres1=null;d.bumper1=null;d.lamps1=null;
          d.doorLeft1=null;d.doorRight1=null;d.dashboard1=null;d.ads1=null;
      ...
      step.Stepper(
        ...
        steps: <step.Step>[
          step.Step(
            ...
            content: Container(
                child: MyHomePage(title: 'asd', file: widget.file,)),
